 ...
 */
public abstract class ServiceBannerAdapter  extends PagerAdapter {

    private final ArrayList<MyHouseInfo.CabinServiceListBean> datas;
    private Context mContext;
    public static int selectPostion = 3;

    public ServiceBannerAdapter(Context context, ArrayList<MyHouseInfo.CabinServiceListBean> data) {
        mContext = context;
        this.datas = data;
    }
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.adapter_banner_service, container, false);
        ...
        Glide.with(mContext)
                .load(datas.get(position).getServiceImg())
                .apply(options)
                .into(iv_house);
