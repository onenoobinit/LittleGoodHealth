 ...
 */
public class CommentQadapter extends MultipleItemRvAdapter<OrderInfo, BaseViewHolder> {
    public CommentQadapter(@Nullable List<OrderInfo> data) {
        super(data);
        finishInitialize();
    }
    ...
    public void registerItemProvider() {
        mProviderDelegate.registerProvider(new QaOneCommentProvider());
        mProviderDelegate.registerProvider(new QaMoreCommentProvider());
    }
}
