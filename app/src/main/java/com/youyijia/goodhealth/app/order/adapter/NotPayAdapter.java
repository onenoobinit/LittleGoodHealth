 ...
 */
public class NotPayAdapter extends MultipleItemRvAdapter<OrderInfo, BaseViewHolder> {
    public NotPayAdapter(@Nullable List<OrderInfo> data) {
        super(data);
        finishInitialize();
    }
    ...
    public void registerItemProvider() {
        mProviderDelegate.registerProvider(new QaNotPayOneProvider());
        mProviderDelegate.registerProvider(new QaNotPayMoreProvider());
    }
}