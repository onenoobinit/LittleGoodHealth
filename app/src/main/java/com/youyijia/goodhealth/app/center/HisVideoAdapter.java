 ...
 */
public class HisVideoAdapter extends RecyclerView.Adapter<HisVideoAdapter.MyViewHolder> {

    private final Context mContext;
    private ArrayList<MicDiscritionInfo.ListBean> datas;

    public HisVideoAdapter(Context context, ArrayList<MicDiscritionInfo.ListBean> datas) {
        this.mContext = context;
        this.datas = datas;
    }

    public void setData(ArrayList<MicDiscritionInfo.ListBean> datas) {
        this.datas = datas;
    }

    public ArrayList<MicDiscritionInfo.ListBean> getData() {
        return datas;
    }
