 ...
 */
public class OtherVideoAdapter extends RecyclerView.Adapter<OtherVideoAdapter.MyViewHolder> {

    private final Context mContext;
    private ArrayList<HisVideoInfo> datas;

    public OtherVideoAdapter(Context context, ArrayList<HisVideoInfo> datas) {
        this.mContext = context;
        this.datas = datas;
    }

    public void setData(ArrayList<HisVideoInfo> datas) {
        this.datas = datas;
    }

    public ArrayList<HisVideoInfo> getData() {
        return datas;
    }
