package com.youyijia.hyoukalibrary.refreshLayout;
...
public class RefreshLayout extends ViewGroup {
        ...
        switch (actionMasked) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (activePointerId == INVALID_POINTER) {
                    L.e(TAG, "Got ACTION_MOVE event but don't have an active pointer id.");
                    return super.dispatchTouchEvent(ev);
                }
                lastEvent = ev;
            ...
            case MotionEvent.ACTION_POINTER_DOWN:
                ...
                if (pointerIndex < 0) {
                    L.e(TAG, "Got ACTION_POINTER_DOWN event but have an invalid action index.");
                    return super.dispatchTouchEvent(ev);
                }
    ...
    private void moveSpinner(float diff) {
        ...
        if (offset > 0) { // 下拉的时候才添加阻力
            offset = (int) (offset * (0.5f - tensionPercent));
...
//        Toast.makeText(getContext(), state.toString(), Toast.LENGTH_SHORT).show();
    ...
    private void setTargetOffsetTopAndBottom(int offset) {
        ...
        lastTargetOffsetTop = currentTargetOffsetTop;
        currentTargetOffsetTop = target.getTop();
//        L.e(TAG, "moveSpinner: currentTargetOffsetTop = "+ currentTargetOffsetTop);
        invalidate();
    }
