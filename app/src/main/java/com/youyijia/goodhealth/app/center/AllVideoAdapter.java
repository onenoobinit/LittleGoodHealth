...
public class AllVideoAdapter extends RecyclerView.Adapter<AllVideoAdapter.MyViewHolder> {
    ...
    private ArrayList<AllVideoInfo> datas;

    public AllVideoAdapter(Context context, ArrayList<AllVideoInfo> datas) {
        this.mContext = context;
        this.datas = datas;
    }

    public void setData(ArrayList<AllVideoInfo> datas) {
        this.datas = datas;
    }

    public ArrayList<AllVideoInfo> getData() {
        return datas;
    }
