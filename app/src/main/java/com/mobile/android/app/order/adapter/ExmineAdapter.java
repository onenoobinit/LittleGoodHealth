 ...
 */
public class ExmineAdapter extends RecyclerView.Adapter<ExmineAdapter.MyViewHolder> {

    private final Context mContext;
    private ArrayList<String> datas;
    private int type;

    public ExmineAdapter(Context context, int i, ArrayList<String> complains) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(mContext).inflate(R.layout.adapter_exmine, null, false));
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private final TextView tvItemStauts;
        ...
        public MyViewHolder(View itemView) {
            ...
            tvItemStauts = itemView.findViewById(R.id.tv_item_status);
        }
    }
}
