            ...
            if ("0".equals(book)) {
                ...
                if (overSpace < 101 && reoverSpace < 100) {
                    ...
                    if (overSpace > 100 && reoverSpace < 101) {
                        ...
                        holder.tv_select_over.setText("剩余舱位" + (100 - Integer.parseInt(datas.get(position).getSpaceData().getReOverSpace())) + "%");
                        holder.pv_select.setProgress(Integer.parseInt(datas.get(position).getSpaceData().getReOverSpace()));
                    }
                }
            }
        } else {
