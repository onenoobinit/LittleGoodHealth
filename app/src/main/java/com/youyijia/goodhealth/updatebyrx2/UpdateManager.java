...
import com.youyijia.goodhealth.entity.UpdateInfoBean;
...
public class UpdateManager {
    ...
    public void checkUpdate(Context context) {
        params.clear();
//        params.put(ApiContstants.UID, GoodHealthApp.getUser().getUid());
//        params.put(ApiContstants.TOKEN, GoodHealthApp.getUser().getToken());
    ...
    private String getVersionName() {
        try {
            String pkName = GoodHealthApp.getInstance().getPackageName();
            String versionName = GoodHealthApp.getInstance().getPackageManager().getPackageInfo(
