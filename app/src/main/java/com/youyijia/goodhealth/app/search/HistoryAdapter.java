 ...
 */
public abstract class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.tv_his_item.setOnClickListener(view -> onTvClick(datas.get(position)));
    }
    ...
    public abstract void onTvClick(String history);
}
