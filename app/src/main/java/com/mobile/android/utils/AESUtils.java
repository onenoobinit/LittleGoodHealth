 ...
 * --------------------------------------------
 * 工程:
 * #0000     mwy     创建日期: 2017-03-20 16:48
 */
...
public class AESUtils {
        ...
        //注意: 这里的pass!word(秘钥必须是16位的)
        private static final String keyBytes = "youjuke00ekujuoy";
        ...
        public static String encode(String content){
            ...
            return Base64.encodeToString(encrypt(content, keyBytes), Base64.DEFAULT);
        }
        ...
        public static String decode(String content){
            ...
            byte[] b = decrypt(Base64.decode(content, Base64.DEFAULT), keyBytes);
            return new String(b);
        }
