package com.mobile.hyoukalibrary.OkhttpCacheInterceptor;

import android.content.Context;

import com.mobile.hyoukalibrary.OkhttpCacheInterceptor.Catch.CacheManager;
...
public class CacheInterceptor implements Interceptor {
    ...
    private Response getCacheResponse(Request request, long oldNow) {
        ...
        L.i("HttpRetrofit", "<-- Get Cache: " + response.code() + " " + response.message() + " " + url + " (" + useTime + "ms)");
